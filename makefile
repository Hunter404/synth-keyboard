...
LIBS_SHARED_BASE := C:\PROGRA~2\Arduino\hardware\teensy\avr\libraries
LIBS_SHARED      := Audio Wire SPI SD SerialFlash

LIBS_LOCAL_BASE  := C:\Users\frelar\Documents\Arduino\libraries
LIBS_LOCAL       := Adafruit_seesaw_Library
...
DEFINES     := -D__MK66FX1M0__ -DTEENSYDUINO=146 -DARDUINO=10807
DEFINES     += -DF_CPU=180000000 -DUSB_MIDI_AUDIO_SERIAL -DLAYOUT_SWEDISH
